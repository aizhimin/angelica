...
public class CollectionUtil {
	...
	/**
	 * 将查询参数map转换成请求参数：key1=value1&key2=value2
	 * @param searchParams
	 * @return
	 */
	public static String encodeSearchParamsMap(Map<String,Object> searchParams) {
		if (CollectionUtil.isEmpty(searchParams)) {
			return "";
		}

		StringBuilder queryStringBuilder = new StringBuilder();
		Iterator<Entry<String, Object>> it = searchParams.entrySet().iterator();
		while (it.hasNext()) {
